...
class Global {
    static final String SERVER_ADDRESS = "http://115.145.170.69:8085/";
    static final String SERVER_IP = "115.145.170.69";
    ...
    static final String SHARED_PREFERENCES_IMEI = "imei";
    ...
    static final int REQ_CODE_PERMISSION_PHONENUMBER=1002;
    static final int REQ_CODE_PERMISSION_STORAGE = 1003;
    static final int REQ_CODE_PERMISSION_CAMERA = 1004;
    static final int REQ_CODE_PERMISSION_OVERLAY = 1005;
